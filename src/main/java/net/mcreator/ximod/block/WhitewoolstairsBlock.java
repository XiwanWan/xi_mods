...
public class WhitewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whitewoolstairs")
	public static final Block block = null;

	public WhitewoolstairsBlock(XiModModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewoolstairs");
		}
