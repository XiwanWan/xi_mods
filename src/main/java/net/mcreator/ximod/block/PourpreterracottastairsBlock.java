...
public class PourpreterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourpreterracottastairs")
	public static final Block block = null;

	public PourpreterracottastairsBlock(XiModModElements instance) {
		super(instance, 307);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pourpreterracottastairs");
		}
