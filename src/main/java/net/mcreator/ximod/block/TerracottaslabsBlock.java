...
public class TerracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:terracottaslabs")
	public static final Block block = null;

	public TerracottaslabsBlock(XiModModElements instance) {
		super(instance, 327);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("terracottaslabs");
		}
