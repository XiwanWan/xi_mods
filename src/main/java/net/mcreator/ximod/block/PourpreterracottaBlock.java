...
public class PourpreterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourpreterracotta")
	public static final Block block = null;

	public PourpreterracottaBlock(XiModModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pourpreterracotta");
		}
