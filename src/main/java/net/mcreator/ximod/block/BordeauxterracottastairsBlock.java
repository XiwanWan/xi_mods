...
public class BordeauxterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxterracottastairs")
	public static final Block block = null;

	public BordeauxterracottastairsBlock(XiModModElements instance) {
		super(instance, 305);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bordeauxterracottastairs");
		}
