...
public class GreenterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenterracottaslabs")
	public static final Block block = null;

	public GreenterracottaslabsBlock(XiModModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("greenterracottaslabs");
		}
