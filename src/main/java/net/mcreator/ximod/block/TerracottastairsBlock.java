...
public class TerracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:terracottastairs")
	public static final Block block = null;

	public TerracottastairsBlock(XiModModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("terracottastairs");
		}
