...
public class LimewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limewoolslabs")
	public static final Block block = null;

	public LimewoolslabsBlock(XiModModElements instance) {
		super(instance, 156);
	}
