...
public class WhitewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whitewoolslabs")
	public static final Block block = null;

	public WhitewoolslabsBlock(XiModModElements instance) {
		super(instance, 162);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("whitewoolslabs");
		}
