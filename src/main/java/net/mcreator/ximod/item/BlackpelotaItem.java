...
public class BlackpelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blackpelota")
	public static final Item block = null;

	public BlackpelotaItem(XiModModElements instance) {
		super(instance, 338);
	}
