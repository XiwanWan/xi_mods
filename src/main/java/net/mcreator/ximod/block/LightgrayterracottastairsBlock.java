...
public class LightgrayterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightgrayterracottastairs")
	public static final Block block = null;

	public LightgrayterracottastairsBlock(XiModModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightgrayterracottastairs");
		}
