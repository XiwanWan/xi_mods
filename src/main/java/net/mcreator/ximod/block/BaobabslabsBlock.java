...
public class BaobabslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabslabs")
	public static final Block block = null;

	public BaobabslabsBlock(XiModModElements instance) {
		super(instance, 56);
	}
