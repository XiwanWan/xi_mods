...
public class LimehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limehayblock")
	public static final Block block = null;

	public LimehayblockBlock(XiModModElements instance) {
		super(instance, 174);
	}
