...
public class BaobabstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabstairs")
	public static final Block block = null;

	public BaobabstairsBlock(XiModModElements instance) {
		super(instance, 55);
	}
