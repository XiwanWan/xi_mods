...
public class LimebluewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limebluewoolslabs")
	public static final Block block = null;

	public LimebluewoolslabsBlock(XiModModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("limebluewoolslabs");
		}
