...
public class BlueexoticorchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blueexoticorchid")
	public static final Block block = null;

	public BlueexoticorchidBlock(XiModModElements instance) {
		super(instance, 16);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blueexoticorchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:blueexoticorchid"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blueexoticorchid");
		}
