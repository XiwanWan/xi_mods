...
public class LightbluewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightbluewoolslabs")
	public static final Block block = null;

	public LightbluewoolslabsBlock(XiModModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightbluewoolslabs");
		}
