...
public class PathslabBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pathslab")
	public static final Block block = null;

	public PathslabBlock(XiModModElements instance) {
		super(instance, 287);
	}
