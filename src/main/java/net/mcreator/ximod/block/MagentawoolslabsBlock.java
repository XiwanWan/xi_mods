...
public class MagentawoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentawoolslabs")
	public static final Block block = null;

	public MagentawoolslabsBlock(XiModModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("magentawoolslabs");
		}
