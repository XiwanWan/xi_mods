...
public class MagentaorchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentaorchid")
	public static final Block block = null;

	public MagentaorchidBlock(XiModModElements instance) {
		super(instance, 18);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magentaorchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:magentaorchid"), configuredFeature);
		}
	}
