...
public class JadewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:jadewoolstairs")
	public static final Block block = null;

	public JadewoolstairsBlock(XiModModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jadewoolstairs");
		}
