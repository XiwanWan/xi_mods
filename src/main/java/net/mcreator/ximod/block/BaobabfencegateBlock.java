...
public class BaobabfencegateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabfencegate")
	public static final Block block = null;

	public BaobabfencegateBlock(XiModModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("baobabfencegate");
		}
