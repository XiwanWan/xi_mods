...
public class BlackwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blackwoolstairs")
	public static final Block block = null;

	public BlackwoolstairsBlock(XiModModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blackwoolstairs");
		}
