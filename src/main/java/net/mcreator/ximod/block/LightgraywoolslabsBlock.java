...
public class LightgraywoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightgraywoolslabs")
	public static final Block block = null;

	public LightgraywoolslabsBlock(XiModModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightgraywoolslabs");
		}
