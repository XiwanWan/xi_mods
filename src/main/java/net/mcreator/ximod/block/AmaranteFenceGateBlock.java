...
public class AmaranteFenceGateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_fence_gate")
	public static final Block block = null;

	public AmaranteFenceGateBlock(XiModModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("amarante_fence_gate");
		}
