...
public class PurpleterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpleterracottaslabs")
	public static final Block block = null;

	public PurpleterracottaslabsBlock(XiModModElements instance) {
		super(instance, 323);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purpleterracottaslabs");
		}
