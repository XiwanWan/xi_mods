...
public class PinkpelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkpelota")
	public static final Item block = null;

	public PinkpelotaItem(XiModModElements instance) {
		super(instance, 349);
	}
