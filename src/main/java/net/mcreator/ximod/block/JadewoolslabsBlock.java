...
public class JadewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:jadewoolslabs")
	public static final Block block = null;

	public JadewoolslabsBlock(XiModModElements instance) {
		super(instance, 34);
	}
