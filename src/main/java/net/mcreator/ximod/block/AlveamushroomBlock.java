...
public class AlveamushroomBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:alveamushroom")
	public static final Block block = null;

	public AlveamushroomBlock(XiModModElements instance) {
		super(instance, 99);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("alveamushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:alveamushroom"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("xi_mod:hetreforest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
