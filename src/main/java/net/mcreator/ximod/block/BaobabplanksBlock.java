...
public class BaobabplanksBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabplanks")
	public static final Block block = null;

	public BaobabplanksBlock(XiModModElements instance) {
		super(instance, 52);
	}
