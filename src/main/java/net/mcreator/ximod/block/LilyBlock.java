...
public class LilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lily")
	public static final Block block = null;

	public LilyBlock(XiModModElements instance) {
		super(instance, 7);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:lily"), configuredFeature);
		}
	}
