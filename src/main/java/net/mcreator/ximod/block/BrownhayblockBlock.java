...
public class BrownhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownhayblock")
	public static final Block block = null;

	public BrownhayblockBlock(XiModModElements instance) {
		super(instance, 168);
	}
