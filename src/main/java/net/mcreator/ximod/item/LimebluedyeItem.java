...
public class LimebluedyeItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limebluedye")
	public static final Item block = null;

	public LimebluedyeItem(XiModModElements instance) {
		super(instance, 6);
	}
