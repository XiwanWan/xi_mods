...
public class MagentaterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentaterracottastairs")
	public static final Block block = null;

	public MagentaterracottastairsBlock(XiModModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("magentaterracottastairs");
		}
