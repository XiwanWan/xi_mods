...
public class BituminouscoalBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bituminouscoal")
	public static final Block block = null;

	public BituminouscoalBlock(XiModModElements instance) {
		super(instance, 114);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("xi_mod:bituminouscoal_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 64)).range(80)
					.square().func_242731_b(6);
			event.getRegistry().register(feature.setRegistryName("bituminouscoal"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:bituminouscoal"), configuredFeature);
		}
	}
