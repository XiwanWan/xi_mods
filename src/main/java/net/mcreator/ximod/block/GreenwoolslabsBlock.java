...
public class GreenwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenwoolslabs")
	public static final Block block = null;

	public GreenwoolslabsBlock(XiModModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("greenwoolslabs");
		}
