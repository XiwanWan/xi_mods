...
public class BlackhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blackhayblock")
	public static final Block block = null;

	public BlackhayblockBlock(XiModModElements instance) {
		super(instance, 166);
	}
