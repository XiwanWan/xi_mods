...
public class PourprewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourprewoolslabs")
	public static final Block block = null;

	public PourprewoolslabsBlock(XiModModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pourprewoolslabs");
		}
