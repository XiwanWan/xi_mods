...
public class SakuradoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:sakuradoor")
	public static final Block block = null;

	public SakuradoorBlock(XiModModElements instance) {
		super(instance, 65);
	}
