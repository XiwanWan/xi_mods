...
public class PurplepelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purplepelota")
	public static final Item block = null;

	public PurplepelotaItem(XiModModElements instance) {
		super(instance, 350);
	}
