...
public class TriangletipiblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:triangletipiblock")
	public static final Block block = null;

	public TriangletipiblockBlock(XiModModElements instance) {
		super(instance, 391);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("triangletipiblock");
		}
