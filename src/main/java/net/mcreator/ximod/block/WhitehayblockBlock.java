...
public class WhitehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whitehayblock")
	public static final Block block = null;

	public WhitehayblockBlock(XiModModElements instance) {
		super(instance, 180);
	}
