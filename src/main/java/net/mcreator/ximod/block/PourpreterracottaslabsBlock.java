...
public class PourpreterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourpreterracottaslabs")
	public static final Block block = null;

	public PourpreterracottaslabsBlock(XiModModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pourpreterracottaslabs");
		}
