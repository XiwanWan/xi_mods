...
public class AmaranteBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante")
	public static final Block block = null;

	public AmaranteBlock(XiModModElements instance) {
		super(instance, 165);
	...
	public void initElements() {
		...
		elements.items.add(() -> new TallBlockItem(block, new Item.Properties().group(XiItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amarante"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:amarante"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.WET_GRASS).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("amarante");
		}
