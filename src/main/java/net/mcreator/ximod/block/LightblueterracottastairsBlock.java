...
public class LightblueterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightblueterracottastairs")
	public static final Block block = null;

	public LightblueterracottastairsBlock(XiModModElements instance) {
		super(instance, 294);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightblueterracottastairs");
		}
