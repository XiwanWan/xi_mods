...
public class LightbluehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightbluehayblock")
	public static final Block block = null;

	public LightbluehayblockBlock(XiModModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightbluehayblock");
		}
