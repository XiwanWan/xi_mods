...
public class BeigewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigewoolstairs")
	public static final Block block = null;

	public BeigewoolstairsBlock(XiModModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("beigewoolstairs");
		}
