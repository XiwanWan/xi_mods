...
public class AmaranteSlabBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_slab")
	public static final Block block = null;

	public AmaranteSlabBlock(XiModModElements instance) {
		super(instance, 75);
	}
