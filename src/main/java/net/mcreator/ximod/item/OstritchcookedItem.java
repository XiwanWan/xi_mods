...
public class OstritchcookedItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:ostritchcooked")
	public static final Item block = null;

	public OstritchcookedItem(XiModModElements instance) {
		super(instance, 108);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(XiItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.3f)
							...
							.meat().build()));
			setRegistryName("ostritchcooked");
		}
