...
public class AmarantedoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarantedoor")
	public static final Block block = null;

	public AmarantedoorBlock(XiModModElements instance) {
		super(instance, 81);
	}
