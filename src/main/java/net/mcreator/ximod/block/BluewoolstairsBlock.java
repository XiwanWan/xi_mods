...
public class BluewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bluewoolstairs")
	public static final Block block = null;

	public BluewoolstairsBlock(XiModModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewoolstairs");
		}
