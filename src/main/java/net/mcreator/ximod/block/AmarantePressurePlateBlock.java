...
public class AmarantePressurePlateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_pressure_plate")
	public static final Block block = null;

	public AmarantePressurePlateBlock(XiModModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("amarante_pressure_plate");
		}
