...
public class SakuraFenceGateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:sakura_fence_gate")
	public static final Block block = null;

	public SakuraFenceGateBlock(XiModModElements instance) {
		super(instance, 70);
	}
