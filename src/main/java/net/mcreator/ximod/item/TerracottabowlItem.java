...
public class TerracottabowlItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:terracottabowl")
	public static final Item block = null;

	public TerracottabowlItem(XiModModElements instance) {
		super(instance, 193);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("terracottabowl");
		}
