...
public class PinkterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkterracottaslabs")
	public static final Block block = null;

	public PinkterracottaslabsBlock(XiModModElements instance) {
		super(instance, 322);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pinkterracottaslabs");
		}
