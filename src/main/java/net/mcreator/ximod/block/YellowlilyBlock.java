...
public class YellowlilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowlily")
	public static final Block block = null;

	public YellowlilyBlock(XiModModElements instance) {
		super(instance, 12);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yellowlily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:yellowlily"), configuredFeature);
		}
	}
