...
public class JadeterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:jadeterracottastairs")
	public static final Block block = null;

	public JadeterracottastairsBlock(XiModModElements instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jadeterracottastairs");
		}
