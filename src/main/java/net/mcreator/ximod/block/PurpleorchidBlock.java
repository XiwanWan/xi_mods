...
public class PurpleorchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpleorchid")
	public static final Block block = null;

	public PurpleorchidBlock(XiModModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("purpleorchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:purpleorchid"), configuredFeature);
		}
	}
