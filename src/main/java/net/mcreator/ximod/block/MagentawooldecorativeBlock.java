...
public class MagentawooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentawooldecorative")
	public static final Block block = null;

	public MagentawooldecorativeBlock(XiModModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magentawooldecorative");
		}
