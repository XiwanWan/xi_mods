...
public class OrangewooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangewooldecorative")
	public static final Block block = null;

	public OrangewooldecorativeBlock(XiModModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangewooldecorative");
		}
