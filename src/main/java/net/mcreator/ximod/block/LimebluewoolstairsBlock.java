...
public class LimebluewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limebluewoolstairs")
	public static final Block block = null;

	public LimebluewoolstairsBlock(XiModModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limebluewoolstairs");
		}
