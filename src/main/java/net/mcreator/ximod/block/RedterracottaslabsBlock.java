...
public class RedterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redterracottaslabs")
	public static final Block block = null;

	public RedterracottaslabsBlock(XiModModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("redterracottaslabs");
		}
