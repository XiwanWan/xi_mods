...
public class RedwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redwoolslabs")
	public static final Block block = null;

	public RedwoolslabsBlock(XiModModElements instance) {
		super(instance, 161);
	}
