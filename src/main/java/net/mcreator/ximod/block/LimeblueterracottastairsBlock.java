...
public class LimeblueterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limeblueterracottastairs")
	public static final Block block = null;

	public LimeblueterracottastairsBlock(XiModModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limeblueterracottastairs");
		}
