...
public class GreenpelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenpelota")
	public static final Item block = null;

	public GreenpelotaItem(XiModModElements instance) {
		super(instance, 343);
	}
