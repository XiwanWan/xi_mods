...
public class OstritchbreedonentitytickupdateProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				XiModMod.LOGGER.warn("Failed to load dependency world for procedure Ostritchbreedonentitytickupdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				XiModMod.LOGGER.warn("Failed to load dependency x for procedure Ostritchbreedonentitytickupdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				XiModMod.LOGGER.warn("Failed to load dependency y for procedure Ostritchbreedonentitytickupdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				XiModMod.LOGGER.warn("Failed to load dependency z for procedure Ostritchbreedonentitytickupdate!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				XiModMod.LOGGER.warn("Failed to load dependency entity for procedure Ostritchbreedonentitytickupdate!");
			return;
		}
		...
		if (!world.isRemote()) {
			if (entity.getPersistentData().getDouble("feedTimer") > 0) {
				entity.getPersistentData().putDouble("breedTimer", (entity.getPersistentData().getDouble("feedTimer") - 1));
			} else {
				posx = (entity.getPosX());
				posy = (entity.getPosY());
				posz = (entity.getPosZ());
