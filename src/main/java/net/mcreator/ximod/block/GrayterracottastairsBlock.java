...
public class GrayterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:grayterracottastairs")
	public static final Block block = null;

	public GrayterracottastairsBlock(XiModModElements instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("grayterracottastairs");
		}
