...
public class RedhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redhayblock")
	public static final Block block = null;

	public RedhayblockBlock(XiModModElements instance) {
		super(instance, 179);
	}
