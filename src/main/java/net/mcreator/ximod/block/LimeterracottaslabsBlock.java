...
public class LimeterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limeterracottaslabs")
	public static final Block block = null;

	public LimeterracottaslabsBlock(XiModModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("limeterracottaslabs");
		}
