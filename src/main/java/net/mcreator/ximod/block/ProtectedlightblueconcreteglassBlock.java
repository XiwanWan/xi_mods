...
public class ProtectedlightblueconcreteglassBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:protectedlightblueconcreteglass")
	public static final Block block = null;

	public ProtectedlightblueconcreteglassBlock(XiModModElements instance) {
		super(instance, 395);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("protectedlightblueconcreteglass");
		}
