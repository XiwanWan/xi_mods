...
public class BordeauxwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxwoolslabs")
	public static final Block block = null;

	public BordeauxwoolslabsBlock(XiModModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bordeauxwoolslabs");
		}
