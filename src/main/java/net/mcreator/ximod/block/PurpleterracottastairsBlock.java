...
public class PurpleterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpleterracottastairs")
	public static final Block block = null;

	public PurpleterracottastairsBlock(XiModModElements instance) {
		super(instance, 300);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purpleterracottastairs");
		}
