...
public class RedterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redterracottastairs")
	public static final Block block = null;

	public RedterracottastairsBlock(XiModModElements instance) {
		super(instance, 301);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("redterracottastairs");
		}
