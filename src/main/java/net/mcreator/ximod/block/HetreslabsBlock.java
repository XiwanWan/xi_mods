...
public class HetreslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetreslabs")
	public static final Block block = null;

	public HetreslabsBlock(XiModModElements instance) {
		super(instance, 45);
	}
