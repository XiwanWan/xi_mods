...
public class GraywooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:graywooldecorative")
	public static final Block block = null;

	public GraywooldecorativeBlock(XiModModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("graywooldecorative");
		}
