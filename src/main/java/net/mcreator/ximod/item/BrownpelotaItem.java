...
public class BrownpelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownpelota")
	public static final Item block = null;

	public BrownpelotaItem(XiModModElements instance) {
		super(instance, 340);
	}
