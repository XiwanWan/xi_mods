...
public class BituminouscoalfragmentItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bituminouscoalfragment")
	public static final Item block = null;

	public BituminouscoalfragmentItem(XiModModElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bituminouscoalfragment");
		}
