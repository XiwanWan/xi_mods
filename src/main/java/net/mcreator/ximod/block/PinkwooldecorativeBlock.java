...
public class PinkwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkwooldecorative")
	public static final Block block = null;

	public PinkwooldecorativeBlock(XiModModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pinkwooldecorative");
		}
