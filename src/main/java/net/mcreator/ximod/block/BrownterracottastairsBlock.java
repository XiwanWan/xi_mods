...
public class BrownterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownterracottastairs")
	public static final Block block = null;

	public BrownterracottastairsBlock(XiModModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brownterracottastairs");
		}
