...
import net.mcreator.ximod.entity.GoatEntity;
...
public class GoatRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoatEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgoat(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("xi_mod:textures/entities/goat.png");
					}
				};
			});
		}
