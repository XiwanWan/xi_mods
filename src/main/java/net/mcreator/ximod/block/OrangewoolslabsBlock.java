...
public class OrangewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangewoolslabs")
	public static final Block block = null;

	public OrangewoolslabsBlock(XiModModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("orangewoolslabs");
		}
