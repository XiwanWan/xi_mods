...
public class PurpurdyeItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurdye")
	public static final Item block = null;

	public PurpurdyeItem(XiModModElements instance) {
		super(instance, 5);
	}
