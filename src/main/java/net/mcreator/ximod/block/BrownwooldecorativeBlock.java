...
public class BrownwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownwooldecorative")
	public static final Block block = null;

	public BrownwooldecorativeBlock(XiModModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brownwooldecorative");
		}
