...
public class YellowwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowwoolslabs")
	public static final Block block = null;

	public YellowwoolslabsBlock(XiModModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellowwoolslabs");
		}
