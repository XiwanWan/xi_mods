...
public class GraywoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:graywoolslabs")
	public static final Block block = null;

	public GraywoolslabsBlock(XiModModElements instance) {
		super(instance, 152);
	}
