...
public class RenforcedglasspaneecBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspaneec")
	public static final Block block = null;

	public RenforcedglasspaneecBlock(XiModModElements instance) {
		super(instance, 402);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspaneec");
		}
