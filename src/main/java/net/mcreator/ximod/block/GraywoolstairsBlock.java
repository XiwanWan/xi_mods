...
public class GraywoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:graywoolstairs")
	public static final Block block = null;

	public GraywoolstairsBlock(XiModModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("graywoolstairs");
		}
