...
public class BaobabfenceBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabfence")
	public static final Block block = null;

	public BaobabfenceBlock(XiModModElements instance) {
		super(instance, 57);
	}
