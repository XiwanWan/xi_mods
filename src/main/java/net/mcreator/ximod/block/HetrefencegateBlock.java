...
public class HetrefencegateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrefencegate")
	public static final Block block = null;

	public HetrefencegateBlock(XiModModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("hetrefencegate");
		}
