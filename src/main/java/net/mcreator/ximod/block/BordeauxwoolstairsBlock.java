...
public class BordeauxwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxwoolstairs")
	public static final Block block = null;

	public BordeauxwoolstairsBlock(XiModModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bordeauxwoolstairs");
		}
