...
public class BordeauxdyeItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxdye")
	public static final Item block = null;

	public BordeauxdyeItem(XiModModElements instance) {
		super(instance, 1);
	}
