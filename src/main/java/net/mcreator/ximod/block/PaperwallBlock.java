...
public class PaperwallBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:paperwall")
	public static final Block block = null;

	public PaperwallBlock(XiModModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 9, 0, 16, 7))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 7, 16, 16, 9))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(9, 0, 0, 7, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(7, 0, 16, 9, 16, 0))
