...
public class BlackterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blackterracottaslabs")
	public static final Block block = null;

	public BlackterracottaslabsBlock(XiModModElements instance) {
		super(instance, 311);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blackterracottaslabs");
		}
