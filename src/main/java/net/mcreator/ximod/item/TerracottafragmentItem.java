...
public class TerracottafragmentItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:terracottafragment")
	public static final Item block = null;

	public TerracottafragmentItem(XiModModElements instance) {
		super(instance, 192);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("terracottafragment");
		}
