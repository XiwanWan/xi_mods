...
public class JadeterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:jadeterracotta")
	public static final Block block = null;

	public JadeterracottaBlock(XiModModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadeterracotta");
		}
