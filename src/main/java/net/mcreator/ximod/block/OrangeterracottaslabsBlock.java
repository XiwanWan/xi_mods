...
public class OrangeterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangeterracottaslabs")
	public static final Block block = null;

	public OrangeterracottaslabsBlock(XiModModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("orangeterracottaslabs");
		}
