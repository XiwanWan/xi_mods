...
public class BlackfeatherItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blackfeather")
	public static final Item block = null;

	public BlackfeatherItem(XiModModElements instance) {
		super(instance, 109);
	}
