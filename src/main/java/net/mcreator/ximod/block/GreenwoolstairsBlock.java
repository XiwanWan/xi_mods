...
public class GreenwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenwoolstairs")
	public static final Block block = null;

	public GreenwoolstairsBlock(XiModModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("greenwoolstairs");
		}
