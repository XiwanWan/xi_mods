...
public class RenforcedglasspaneceBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspanece")
	public static final Block block = null;

	public RenforcedglasspaneceBlock(XiModModElements instance) {
		super(instance, 397);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspanece");
		}
