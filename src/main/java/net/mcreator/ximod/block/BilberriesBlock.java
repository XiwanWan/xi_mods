...
import net.mcreator.ximod.procedures.BilberriesonrightclickedProcedure;
...
public class BilberriesBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bilberries")
	public static final Block block = null;

	public BilberriesBlock(XiModModElements instance) {
		super(instance, 214);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bilberries"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:bilberries"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			BilberriesonrightclickedProcedure.executeProcedure(Stream
