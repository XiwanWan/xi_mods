...
public class HetrebuttonBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrebutton")
	public static final Block block = null;

	public HetrebuttonBlock(XiModModElements instance) {
		super(instance, 46);
	}
