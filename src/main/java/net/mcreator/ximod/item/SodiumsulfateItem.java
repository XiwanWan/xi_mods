...
public class SodiumsulfateItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:sodiumsulfate")
	public static final Item block = null;

	public SodiumsulfateItem(XiModModElements instance) {
		super(instance, 113);
	}
