...
public class PinkwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkwoolstairs")
	public static final Block block = null;

	public PinkwoolstairsBlock(XiModModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pinkwoolstairs");
		}
