...
public class PourprelilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourprelily")
	public static final Block block = null;

	public PourprelilyBlock(XiModModElements instance) {
		super(instance, 10);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pourprelily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:pourprelily"), configuredFeature);
		}
	}
