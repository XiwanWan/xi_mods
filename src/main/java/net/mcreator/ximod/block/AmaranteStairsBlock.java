...
public class AmaranteStairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_stairs")
	public static final Block block = null;

	public AmaranteStairsBlock(XiModModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("amarante_stairs");
		}
