...
public class BrownwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownwoolstairs")
	public static final Block block = null;

	public BrownwoolstairsBlock(XiModModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brownwoolstairs");
		}
