...
public class HetreplanksBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetreplanks")
	public static final Block block = null;

	public HetreplanksBlock(XiModModElements instance) {
		super(instance, 41);
	}
