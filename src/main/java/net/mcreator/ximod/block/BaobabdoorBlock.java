...
public class BaobabdoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabdoor")
	public static final Block block = null;

	public BaobabdoorBlock(XiModModElements instance) {
		super(instance, 53);
	}
