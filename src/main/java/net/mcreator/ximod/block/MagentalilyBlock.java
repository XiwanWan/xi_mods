...
public class MagentalilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentalily")
	public static final Block block = null;

	public MagentalilyBlock(XiModModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magentalily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:magentalily"), configuredFeature);
		}
	}
