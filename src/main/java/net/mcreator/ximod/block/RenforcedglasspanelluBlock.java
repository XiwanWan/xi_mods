...
public class RenforcedglasspanelluBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspanellu")
	public static final Block block = null;

	public RenforcedglasspanelluBlock(XiModModElements instance) {
		super(instance, 398);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspanellu");
		}
