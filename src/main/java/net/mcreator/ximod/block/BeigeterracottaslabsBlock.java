...
public class BeigeterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigeterracottaslabs")
	public static final Block block = null;

	public BeigeterracottaslabsBlock(XiModModElements instance) {
		super(instance, 329);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("beigeterracottaslabs");
		}
