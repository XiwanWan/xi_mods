...
public class PurplehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purplehayblock")
	public static final Block block = null;

	public PurplehayblockBlock(XiModModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purplehayblock");
		}
