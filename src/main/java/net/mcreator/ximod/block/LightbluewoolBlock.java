...
public class LightbluewoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightbluewool")
	public static final Block block = null;

	public LightbluewoolBlock(XiModModElements instance) {
		super(instance, 138);
	}
