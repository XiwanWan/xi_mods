...
public class CyanterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanterracottaslabs")
	public static final Block block = null;

	public CyanterracottaslabsBlock(XiModModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanterracottaslabs");
		}
