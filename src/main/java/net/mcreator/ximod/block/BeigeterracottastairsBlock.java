...
public class BeigeterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigeterracottastairs")
	public static final Block block = null;

	public BeigeterracottastairsBlock(XiModModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("beigeterracottastairs");
		}
