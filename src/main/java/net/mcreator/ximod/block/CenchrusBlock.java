...
public class CenchrusBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cenchrus")
	public static final Block block = null;

	public CenchrusBlock(XiModModElements instance) {
		super(instance, 97);
