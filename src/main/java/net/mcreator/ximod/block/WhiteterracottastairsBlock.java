...
public class WhiteterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whiteterracottastairs")
	public static final Block block = null;

	public WhiteterracottastairsBlock(XiModModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("whiteterracottastairs");
		}
