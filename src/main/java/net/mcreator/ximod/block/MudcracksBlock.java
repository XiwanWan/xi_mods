...
public class MudcracksBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:mudcracks")
	public static final Block block = null;

	public MudcracksBlock(XiModModElements instance) {
		super(instance, 164);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("xi_mod:mudcracks_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 32)).range(80)
					.square().func_242731_b(3);
			event.getRegistry().register(feature.setRegistryName("mudcracks"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:mudcracks"), configuredFeature);
		}
	}
