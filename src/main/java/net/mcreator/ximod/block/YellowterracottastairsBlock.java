...
public class YellowterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowterracottastairs")
	public static final Block block = null;

	public YellowterracottastairsBlock(XiModModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellowterracottastairs");
		}
