...
public class PinkorchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkorchid")
	public static final Block block = null;

	public PinkorchidBlock(XiModModElements instance) {
		super(instance, 19);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pinkorchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:pinkorchid"), configuredFeature);
		}
	}
