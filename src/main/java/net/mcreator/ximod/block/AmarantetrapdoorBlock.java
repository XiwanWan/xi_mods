...
public class AmarantetrapdoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarantetrapdoor")
	public static final Block block = null;

	public AmarantetrapdoorBlock(XiModModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("amarantetrapdoor");
		}
