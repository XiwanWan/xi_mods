...
public class Asphaltx15Block extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:asphaltx_15")
	public static final Block block = null;

	public Asphaltx15Block(XiModModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("When you walks on this asphalt block you are 1.5x more fast."));
		}
