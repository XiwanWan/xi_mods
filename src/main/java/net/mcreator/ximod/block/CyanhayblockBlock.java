...
public class CyanhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanhayblock")
	public static final Block block = null;

	public CyanhayblockBlock(XiModModElements instance) {
		super(instance, 169);
	}
