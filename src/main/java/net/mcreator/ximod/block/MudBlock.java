...
public class MudBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:mud")
	public static final Block block = null;

	public MudBlock(XiModModElements instance) {
		super(instance, 94);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("xi_mod:mud_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("mud"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:mud"), configuredFeature);
		}
	}
