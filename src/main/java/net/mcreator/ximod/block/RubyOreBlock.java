...
import net.mcreator.ximod.item.RubyItem;
...
public class RubyOreBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:ruby_ore")
	public static final Block block = null;

	public RubyOreBlock(XiModModElements instance) {
		super(instance, 183);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("xi_mod:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:ruby_ore"), configuredFeature);
		}
	}
