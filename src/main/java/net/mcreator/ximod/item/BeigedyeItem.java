...
public class BeigedyeItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigedye")
	public static final Item block = null;

	public BeigedyeItem(XiModModElements instance) {
		super(instance, 2);
	}
