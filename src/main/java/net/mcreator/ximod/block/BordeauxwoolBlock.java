...
public class BordeauxwoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxwool")
	public static final Block block = null;

	public BordeauxwoolBlock(XiModModElements instance) {
		super(instance, 26);
	}
