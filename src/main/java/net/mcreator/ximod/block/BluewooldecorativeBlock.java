...
public class BluewooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bluewooldecorative")
	public static final Block block = null;

	public BluewooldecorativeBlock(XiModModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluewooldecorative");
		}
