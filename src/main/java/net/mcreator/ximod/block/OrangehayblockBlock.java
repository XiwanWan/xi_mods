...
public class OrangehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangehayblock")
	public static final Block block = null;

	public OrangehayblockBlock(XiModModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orangehayblock");
		}
