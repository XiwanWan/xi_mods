...
public class BenchBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bench")
	public static final Block block = null;

	public BenchBlock(XiModModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 16, -16, 16, 0))
				...
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 0, 0, 0, 16, 32))
							...
							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(0, 0, 16, 16, 16, -16))
