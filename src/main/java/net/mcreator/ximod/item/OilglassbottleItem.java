...
public class OilglassbottleItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:oilglassbottle")
	public static final Item block = null;

	public OilglassbottleItem(XiModModElements instance) {
		super(instance, 185);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("oilglassbottle");
		}
