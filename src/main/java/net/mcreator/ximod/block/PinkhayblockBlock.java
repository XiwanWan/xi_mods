...
public class PinkhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkhayblock")
	public static final Block block = null;

	public PinkhayblockBlock(XiModModElements instance) {
		super(instance, 177);
	}
