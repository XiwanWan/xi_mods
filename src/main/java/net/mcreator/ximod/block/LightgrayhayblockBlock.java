...
public class LightgrayhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightgrayhayblock")
	public static final Block block = null;

	public LightgrayhayblockBlock(XiModModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightgrayhayblock");
		}
