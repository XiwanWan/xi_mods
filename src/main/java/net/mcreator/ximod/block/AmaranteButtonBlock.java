...
public class AmaranteButtonBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_button")
	public static final Block block = null;

	public AmaranteButtonBlock(XiModModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("amarante_button");
		}
