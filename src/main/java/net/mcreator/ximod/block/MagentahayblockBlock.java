...
public class MagentahayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentahayblock")
	public static final Block block = null;

	public MagentahayblockBlock(XiModModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magentahayblock");
		}
