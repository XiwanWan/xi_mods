...
public class AridgrassBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:aridgrass")
	public static final Block block = null;

	public AridgrassBlock(XiModModElements instance) {
		super(instance, 95);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aridgrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:aridgrass"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.HEALTH_BOOST, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.WET_GRASS)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("aridgrass");
		}
