...
public class HetreleavesBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetreleaves")
	public static final Block block = null;

	public HetreleavesBlock(XiModModElements instance) {
		super(instance, 40);
