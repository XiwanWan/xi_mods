...
public class HetrestairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrestairs")
	public static final Block block = null;

	public HetrestairsBlock(XiModModElements instance) {
		super(instance, 44);
	}
