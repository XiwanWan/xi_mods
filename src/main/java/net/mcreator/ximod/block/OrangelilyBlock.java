...
public class OrangelilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangelily")
	public static final Block block = null;

	public OrangelilyBlock(XiModModElements instance) {
		super(instance, 9);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orangelily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:orangelily"), configuredFeature);
		}
	}
