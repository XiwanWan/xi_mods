...
public class BaobablogBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobablog")
	public static final Block block = null;

	public BaobablogBlock(XiModModElements instance) {
		super(instance, 48);
	}
