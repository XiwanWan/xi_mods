...
public class PurpurwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurwoolstairs")
	public static final Block block = null;

	public PurpurwoolstairsBlock(XiModModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purpurwoolstairs");
		}
