...
public class OrangewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangewoolstairs")
	public static final Block block = null;

	public OrangewoolstairsBlock(XiModModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orangewoolstairs");
		}
