...
public class PurpurwoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurwool")
	public static final Block block = null;

	public PurpurwoolBlock(XiModModElements instance) {
		super(instance, 23);
	}
