...
import net.mcreator.ximod.entity.CamelEntity;
...
public class CamelRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CamelEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcamel(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("xi_mod:textures/entities/camel.png");
					}
				};
			});
		}
