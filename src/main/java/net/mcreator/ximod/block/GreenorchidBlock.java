...
public class GreenorchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenorchid")
	public static final Block block = null;

	public GreenorchidBlock(XiModModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("greenorchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:greenorchid"), configuredFeature);
		}
	}
