...
public class PourprewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourprewoolstairs")
	public static final Block block = null;

	public PourprewoolstairsBlock(XiModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pourprewoolstairs");
		}
