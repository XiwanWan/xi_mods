...
public class LimeterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limeterracottastairs")
	public static final Block block = null;

	public LimeterracottastairsBlock(XiModModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limeterracottastairs");
		}
