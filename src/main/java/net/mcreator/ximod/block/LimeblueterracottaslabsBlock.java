...
public class LimeblueterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limeblueterracottaslabs")
	public static final Block block = null;

	public LimeblueterracottaslabsBlock(XiModModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("limeblueterracottaslabs");
		}
