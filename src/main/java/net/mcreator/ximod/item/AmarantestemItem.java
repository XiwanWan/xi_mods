...
public class AmarantestemItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarantestem")
	public static final Item block = null;

	public AmarantestemItem(XiModModElements instance) {
		super(instance, 82);
	}
