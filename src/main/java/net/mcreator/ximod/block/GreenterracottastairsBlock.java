...
public class GreenterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenterracottastairs")
	public static final Block block = null;

	public GreenterracottastairsBlock(XiModModElements instance) {
		super(instance, 293);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).notSolid()
							.setOpaque((bs, br, bp) -> false));
			setRegistryName("greenterracottastairs");
		}
