...
public class YellowwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowwooldecorative")
	public static final Block block = null;

	public YellowwooldecorativeBlock(XiModModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellowwooldecorative");
		}
