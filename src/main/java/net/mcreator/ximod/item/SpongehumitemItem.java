...
public class SpongehumitemItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:spongehumitem")
	public static final Item block = null;

	public SpongehumitemItem(XiModModElements instance) {
		super(instance, 111);
	}
