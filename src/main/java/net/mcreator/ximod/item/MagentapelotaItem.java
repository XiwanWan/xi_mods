...
public class MagentapelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentapelota")
	public static final Item block = null;

	public MagentapelotaItem(XiModModElements instance) {
		super(instance, 347);
	}
