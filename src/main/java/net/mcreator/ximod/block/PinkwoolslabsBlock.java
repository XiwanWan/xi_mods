...
public class PinkwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkwoolslabs")
	public static final Block block = null;

	public PinkwoolslabsBlock(XiModModElements instance) {
		super(instance, 159);
	}
