...
public class GrayterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:grayterracottaslabs")
	public static final Block block = null;

	public GrayterracottaslabsBlock(XiModModElements instance) {
		super(instance, 315);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("grayterracottaslabs");
		}
