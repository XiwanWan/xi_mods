...
public class RenforceddecorativeglasspanebottomBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforceddecorativeglasspanebottom")
	public static final Block block = null;

	public RenforceddecorativeglasspanebottomBlock(XiModModElements instance) {
		super(instance, 401);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforceddecorativeglasspanebottom");
		}
