...
public class YellowwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowwoolstairs")
	public static final Block block = null;

	public YellowwoolstairsBlock(XiModModElements instance) {
		super(instance, 147);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellowwoolstairs");
		}
