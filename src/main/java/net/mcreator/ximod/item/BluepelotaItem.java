...
public class BluepelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bluepelota")
	public static final Item block = null;

	public BluepelotaItem(XiModModElements instance) {
		super(instance, 339);
	}
