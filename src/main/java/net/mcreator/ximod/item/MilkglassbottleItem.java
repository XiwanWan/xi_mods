...
public class MilkglassbottleItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:milkglassbottle")
	public static final Item block = null;

	public MilkglassbottleItem(XiModModElements instance) {
		super(instance, 106);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("milkglassbottle");
		}
