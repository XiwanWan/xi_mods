...
public class RedwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redwoolstairs")
	public static final Block block = null;

	public RedwoolstairsBlock(XiModModElements instance) {
		super(instance, 145);
	}
