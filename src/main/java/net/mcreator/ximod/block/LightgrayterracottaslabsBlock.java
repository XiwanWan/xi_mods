...
public class LightgrayterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightgrayterracottaslabs")
	public static final Block block = null;

	public LightgrayterracottaslabsBlock(XiModModElements instance) {
		super(instance, 318);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightgrayterracottaslabs");
		}
