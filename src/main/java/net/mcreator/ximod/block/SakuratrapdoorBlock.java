...
public class SakuratrapdoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:sakuratrapdoor")
	public static final Block block = null;

	public SakuratrapdoorBlock(XiModModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sakuratrapdoor");
		}
