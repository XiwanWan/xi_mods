...
public class LimewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limewoolstairs")
	public static final Block block = null;

	public LimewoolstairsBlock(XiModModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limewoolstairs");
		}
