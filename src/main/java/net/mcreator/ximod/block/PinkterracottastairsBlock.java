...
public class PinkterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinkterracottastairs")
	public static final Block block = null;

	public PinkterracottastairsBlock(XiModModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pinkterracottastairs");
		}
