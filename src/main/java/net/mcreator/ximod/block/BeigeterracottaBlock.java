...
public class BeigeterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigeterracotta")
	public static final Block block = null;

	public BeigeterracottaBlock(XiModModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("beigeterracotta");
		}
