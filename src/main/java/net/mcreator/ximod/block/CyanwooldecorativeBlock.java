...
public class CyanwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanwooldecorative")
	public static final Block block = null;

	public CyanwooldecorativeBlock(XiModModElements instance) {
		super(instance, 123);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cyanwooldecorative");
		}
