...
public class MagentawoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentawoolstairs")
	public static final Block block = null;

	public MagentawoolstairsBlock(XiModModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("magentawoolstairs");
		}
