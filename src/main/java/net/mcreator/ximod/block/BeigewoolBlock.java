...
public class BeigewoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigewool")
	public static final Block block = null;

	public BeigewoolBlock(XiModModElements instance) {
		super(instance, 35);
	}
