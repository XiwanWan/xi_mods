...
public class PinklilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pinklily")
	public static final Block block = null;

	public PinklilyBlock(XiModModElements instance) {
		super(instance, 11);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pinklily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:pinklily"), configuredFeature);
		}
	}
