...
public class LightblueterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightblueterracottaslabs")
	public static final Block block = null;

	public LightblueterracottaslabsBlock(XiModModElements instance) {
		super(instance, 317);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightblueterracottaslabs");
		}
