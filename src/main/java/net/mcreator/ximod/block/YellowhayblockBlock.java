...
public class YellowhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowhayblock")
	public static final Block block = null;

	public YellowhayblockBlock(XiModModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellowhayblock");
		}
