...
public class CyanwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanwoolslabs")
	public static final Block block = null;

	public CyanwoolslabsBlock(XiModModElements instance) {
		super(instance, 151);
	}
