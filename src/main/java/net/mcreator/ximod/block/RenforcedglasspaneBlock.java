...
public class RenforcedglasspaneBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspane")
	public static final Block block = null;

	public RenforcedglasspaneBlock(XiModModElements instance) {
		super(instance, 396);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspane");
		}
