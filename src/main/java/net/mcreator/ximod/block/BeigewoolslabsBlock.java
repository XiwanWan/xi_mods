...
public class BeigewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:beigewoolslabs")
	public static final Block block = null;

	public BeigewoolslabsBlock(XiModModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("beigewoolslabs");
		}
