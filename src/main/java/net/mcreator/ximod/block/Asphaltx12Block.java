...
public class Asphaltx12Block extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:asphaltx_12")
	public static final Block block = null;

	public Asphaltx12Block(XiModModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("When you walks on this asphalt block you are 1.2x more fast."));
		}
