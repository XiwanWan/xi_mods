...
public class LimebluewoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limebluewool")
	public static final Block block = null;

	public LimebluewoolBlock(XiModModElements instance) {
		super(instance, 20);
	}
