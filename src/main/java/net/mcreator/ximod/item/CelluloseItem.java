...
public class CelluloseItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cellulose")
	public static final Item block = null;

	public CelluloseItem(XiModModElements instance) {
		super(instance, 112);
	}
