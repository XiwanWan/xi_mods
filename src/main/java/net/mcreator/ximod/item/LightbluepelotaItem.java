...
public class LightbluepelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightbluepelota")
	public static final Item block = null;

	public LightbluepelotaItem(XiModModElements instance) {
		super(instance, 344);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lightbluepelota");
		}
