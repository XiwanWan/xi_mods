...
public class AmaranteFenceBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_fence")
	public static final Block block = null;

	public AmaranteFenceBlock(XiModModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("amarante_fence");
		}
