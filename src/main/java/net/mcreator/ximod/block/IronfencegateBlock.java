...
public class IronfencegateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:ironfencegate")
	public static final Block block = null;

	public IronfencegateBlock(XiModModElements instance) {
		super(instance, 335);
	}
