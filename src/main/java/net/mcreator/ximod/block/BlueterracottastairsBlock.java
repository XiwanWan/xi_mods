...
public class BlueterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blueterracottastairs")
	public static final Block block = null;

	public BlueterracottastairsBlock(XiModModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blueterracottastairs");
		}
