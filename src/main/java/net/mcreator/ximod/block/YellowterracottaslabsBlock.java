...
public class YellowterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yellowterracottaslabs")
	public static final Block block = null;

	public YellowterracottaslabsBlock(XiModModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellowterracottaslabs");
		}
