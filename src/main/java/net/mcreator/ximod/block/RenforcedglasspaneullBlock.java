...
public class RenforcedglasspaneullBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspaneull")
	public static final Block block = null;

	public RenforcedglasspaneullBlock(XiModModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspaneull");
		}
