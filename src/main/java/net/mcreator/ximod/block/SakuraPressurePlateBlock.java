...
public class SakuraPressurePlateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:sakura_pressure_plate")
	public static final Block block = null;

	public SakuraPressurePlateBlock(XiModModElements instance) {
		super(instance, 71);
	}
