...
public class HetrelogBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrelog")
	public static final Block block = null;

	public HetrelogBlock(XiModModElements instance) {
		super(instance, 39);
	}
