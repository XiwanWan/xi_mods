...
public class PurplewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purplewoolslabs")
	public static final Block block = null;

	public PurplewoolslabsBlock(XiModModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purplewoolslabs");
		}
