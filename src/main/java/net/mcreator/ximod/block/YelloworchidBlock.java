...
public class YelloworchidBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:yelloworchid")
	public static final Block block = null;

	public YelloworchidBlock(XiModModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yelloworchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:yelloworchid"), configuredFeature);
		}
	}
