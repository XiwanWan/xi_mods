...
public class BaobabbuttonBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabbutton")
	public static final Block block = null;

	public BaobabbuttonBlock(XiModModElements instance) {
		super(instance, 59);
	}
