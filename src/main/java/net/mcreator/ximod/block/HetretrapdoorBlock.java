...
public class HetretrapdoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetretrapdoor")
	public static final Block block = null;

	public HetretrapdoorBlock(XiModModElements instance) {
		super(instance, 43);
	}
