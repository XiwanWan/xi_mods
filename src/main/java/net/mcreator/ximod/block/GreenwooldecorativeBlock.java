...
public class GreenwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenwooldecorative")
	public static final Block block = null;

	public GreenwooldecorativeBlock(XiModModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("greenwooldecorative");
		}
