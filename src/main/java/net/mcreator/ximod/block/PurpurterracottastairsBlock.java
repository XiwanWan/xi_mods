...
public class PurpurterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurterracottastairs")
	public static final Block block = null;

	public PurpurterracottastairsBlock(XiModModElements instance) {
		super(instance, 310);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purpurterracottastairs");
		}
