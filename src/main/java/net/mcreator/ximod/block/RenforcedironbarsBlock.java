...
public class RenforcedironbarsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedironbars")
	public static final Block block = null;

	public RenforcedironbarsBlock(XiModModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedironbars");
		}
