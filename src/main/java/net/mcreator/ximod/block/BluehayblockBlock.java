...
public class BluehayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bluehayblock")
	public static final Block block = null;

	public BluehayblockBlock(XiModModElements instance) {
		super(instance, 167);
	}
