...
public class HetrepressureplateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrepressureplate")
	public static final Block block = null;

	public HetrepressureplateBlock(XiModModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("hetrepressureplate");
		}
