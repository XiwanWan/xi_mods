...
public class RenforcedironingotItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedironingot")
	public static final Item block = null;

	public RenforcedironingotItem(XiModModElements instance) {
		super(instance, 86);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("renforcedironingot");
		}
