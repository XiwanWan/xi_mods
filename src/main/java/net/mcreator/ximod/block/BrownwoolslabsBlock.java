...
public class BrownwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownwoolslabs")
	public static final Block block = null;

	public BrownwoolslabsBlock(XiModModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("brownwoolslabs");
		}
