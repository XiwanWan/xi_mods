...
public class BaobabpressureplateBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:baobabpressureplate")
	public static final Block block = null;

	public BaobabpressureplateBlock(XiModModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f)
					.setLightLevel(s -> 0).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("baobabpressureplate");
		}
