...
public class PurpurterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurterracottaslabs")
	public static final Block block = null;

	public PurpurterracottaslabsBlock(XiModModElements instance) {
		super(instance, 333);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purpurterracottaslabs");
		}
