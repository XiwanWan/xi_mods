...
public class CyanwoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanwoolstairs")
	public static final Block block = null;

	public CyanwoolstairsBlock(XiModModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanwoolstairs");
		}
