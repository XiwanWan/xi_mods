...
public class PurplewoolstairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purplewoolstairs")
	public static final Block block = null;

	public PurplewoolstairsBlock(XiModModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purplewoolstairs");
		}
