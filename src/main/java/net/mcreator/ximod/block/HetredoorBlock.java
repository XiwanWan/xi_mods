...
public class HetredoorBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetredoor")
	public static final Block block = null;

	public HetredoorBlock(XiModModElements instance) {
		super(instance, 42);
	}
