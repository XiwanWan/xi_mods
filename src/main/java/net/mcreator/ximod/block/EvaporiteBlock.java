...
public class EvaporiteBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:evaporite")
	public static final Block block = null;

	public EvaporiteBlock(XiModModElements instance) {
		super(instance, 116);
	}
