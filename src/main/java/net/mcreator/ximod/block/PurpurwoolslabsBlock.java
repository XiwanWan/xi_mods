...
public class PurpurwoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurwoolslabs")
	public static final Block block = null;

	public PurpurwoolslabsBlock(XiModModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purpurwoolslabs");
		}
