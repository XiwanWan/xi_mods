...
public class RedlilyBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redlily")
	public static final Block block = null;

	public RedlilyBlock(XiModModElements instance) {
		super(instance, 13);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("redlily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("xi_mod:redlily"), configuredFeature);
		}
	}
