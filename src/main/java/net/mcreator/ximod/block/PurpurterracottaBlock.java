...
public class PurpurterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:purpurterracotta")
	public static final Block block = null;

	public PurpurterracottaBlock(XiModModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purpurterracotta");
		}
