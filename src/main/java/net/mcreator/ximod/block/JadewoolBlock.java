...
public class JadewoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:jadewool")
	public static final Block block = null;

	public JadewoolBlock(XiModModElements instance) {
		super(instance, 32);
	}
