...
public class WhitetriangletipiblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whitetriangletipiblock")
	public static final Block block = null;

	public WhitetriangletipiblockBlock(XiModModElements instance) {
		super(instance, 393);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(5f, 10f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("whitetriangletipiblock");
		}
