...
public class BordeauxterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxterracotta")
	public static final Block block = null;

	public BordeauxterracottaBlock(XiModModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bordeauxterracotta");
		}
