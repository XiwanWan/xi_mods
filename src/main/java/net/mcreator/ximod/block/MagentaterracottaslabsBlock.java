...
public class MagentaterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:magentaterracottaslabs")
	public static final Block block = null;

	public MagentaterracottaslabsBlock(XiModModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("magentaterracottaslabs");
		}
