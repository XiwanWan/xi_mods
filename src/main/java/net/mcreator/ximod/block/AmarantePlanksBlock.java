...
public class AmarantePlanksBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:amarante_planks")
	public static final Block block = null;

	public AmarantePlanksBlock(XiModModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amarante_planks");
		}
