...
public class RenforcedglasspaneleBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforcedglasspanele")
	public static final Block block = null;

	public RenforcedglasspaneleBlock(XiModModElements instance) {
		super(instance, 399);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforcedglasspanele");
		}
