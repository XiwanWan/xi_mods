...
public class GraypelotaItem extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:graypelota")
	public static final Item block = null;

	public GraypelotaItem(XiModModElements instance) {
		super(instance, 342);
	}
