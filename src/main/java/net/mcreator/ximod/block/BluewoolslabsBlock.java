...
public class BluewoolslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bluewoolslabs")
	public static final Block block = null;

	public BluewoolslabsBlock(XiModModElements instance) {
		super(instance, 149);
	}
