...
public class IronfenceBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:ironfence")
	public static final Block block = null;

	public IronfenceBlock(XiModModElements instance) {
		super(instance, 334);
	}
