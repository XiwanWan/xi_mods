...
public class RedwooldecorativeBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:redwooldecorative")
	public static final Block block = null;

	public RedwooldecorativeBlock(XiModModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redwooldecorative");
		}
