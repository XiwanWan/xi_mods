...
public class BlueterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:blueterracottaslabs")
	public static final Block block = null;

	public BlueterracottaslabsBlock(XiModModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blueterracottaslabs");
		}
