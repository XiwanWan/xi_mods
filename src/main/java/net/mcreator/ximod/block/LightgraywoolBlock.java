...
public class LightgraywoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:lightgraywool")
	public static final Block block = null;

	public LightgraywoolBlock(XiModModElements instance) {
		super(instance, 139);
	}
