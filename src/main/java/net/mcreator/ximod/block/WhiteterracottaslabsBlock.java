...
public class WhiteterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:whiteterracottaslabs")
	public static final Block block = null;

	public WhiteterracottaslabsBlock(XiModModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("whiteterracottaslabs");
		}
