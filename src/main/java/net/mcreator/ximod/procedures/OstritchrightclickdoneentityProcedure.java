...
public class OstritchrightclickdoneentityProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				XiModMod.LOGGER.warn("Failed to load dependency world for procedure Ostritchrightclickdoneentity!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				XiModMod.LOGGER.warn("Failed to load dependency x for procedure Ostritchrightclickdoneentity!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				XiModMod.LOGGER.warn("Failed to load dependency y for procedure Ostritchrightclickdoneentity!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				XiModMod.LOGGER.warn("Failed to load dependency z for procedure Ostritchrightclickdoneentity!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				XiModMod.LOGGER.warn("Failed to load dependency entity for procedure Ostritchrightclickdoneentity!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				XiModMod.LOGGER.warn("Failed to load dependency sourceentity for procedure Ostritchrightclickdoneentity!");
			return;
		}
		...
		if (!world.isRemote() && entity.getPersistentData().getDouble("feedTimer") == 0
			...
			feedTimer = 6000;
			breedTimer = (entity.getPersistentData().getDouble("breedTimer"));
			babyTimer = (entity.getPersistentData().getDouble("babyTimer"));
			particleTimer = (entity.getPersistentData().getDouble("particleTimer"));
			if ((sourceentity instanceof PlayerEntity || sourceentity instanceof ServerPlayerEntity) && !(new Object() {
					...
					private void run() {
						if (world instanceof World && !world.isRemote()) {
							((World) world).playSound(null, new BlockPos(entity.getPosX(), entity.getPosY(), entity.getPosZ()),
									...
									SoundCategory.NEUTRAL, (float) 0.65, (float) 1);
						} else {
							((World) world).playSound((entity.getPosX()), (entity.getPosY()), (entity.getPosZ()),
									(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.fox.eat")),
									SoundCategory.NEUTRAL, (float) 0.65, (float) 1, false);
						}
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				}.start(world, (int) eatSoundDelay);
				eatSoundDelay = (eatSoundDelay + MathHelper.nextInt(new Random(), 5, 15));
			}
			if (world instanceof ServerWorld) {
				Entity entityToSpawn = new OstritchbreedEntity.CustomEntity(OstritchbreedEntity.entity, (World) world);
			...
			if (!entity.world.isRemote())
				entity.remove();
			if (((Entity) world.getEntitiesWithinAABB(OstritchbreedEntity.CustomEntity.class,
				...
				targetentity = (Entity) world.getEntitiesWithinAABB(OstritchbreedEntity.CustomEntity.class,
						new AxisAlignedBB(posx - (1 / 2d), posy - (1 / 2d), posz - (1 / 2d), posx + (1 / 2d), posy + (1 / 2d), posz + (1 / 2d)), null)
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								return Comparator.comparing((Function<Entity, Double>) (_entcnd -> _entcnd.getDistanceSq(_x, _y, _z)));
