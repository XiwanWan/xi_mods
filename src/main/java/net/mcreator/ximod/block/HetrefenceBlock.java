...
public class HetrefenceBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:hetrefence")
	public static final Block block = null;

	public HetrefenceBlock(XiModModElements instance) {
		super(instance, 50);
	}
