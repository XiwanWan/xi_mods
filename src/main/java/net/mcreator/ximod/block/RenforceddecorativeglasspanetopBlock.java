...
public class RenforceddecorativeglasspanetopBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:renforceddecorativeglasspanetop")
	public static final Block block = null;

	public RenforceddecorativeglasspanetopBlock(XiModModElements instance) {
		super(instance, 400);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("renforceddecorativeglasspanetop");
		}
