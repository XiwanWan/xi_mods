...
public class OrangeterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:orangeterracottastairs")
	public static final Block block = null;

	public OrangeterracottastairsBlock(XiModModElements instance) {
		super(instance, 298);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orangeterracottastairs");
		}
