...
public class GreenhayblockBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:greenhayblock")
	public static final Block block = null;

	public GreenhayblockBlock(XiModModElements instance) {
		super(instance, 171);
	}
