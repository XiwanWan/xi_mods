...
public class BrownterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:brownterracottaslabs")
	public static final Block block = null;

	public BrownterracottaslabsBlock(XiModModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("brownterracottaslabs");
		}
