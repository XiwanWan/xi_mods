...
public class LimeblueterracottaBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:limeblueterracotta")
	public static final Block block = null;

	public LimeblueterracottaBlock(XiModModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("limeblueterracotta");
		}
