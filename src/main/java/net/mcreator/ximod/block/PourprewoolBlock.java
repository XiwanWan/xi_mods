...
public class PourprewoolBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:pourprewool")
	public static final Block block = null;

	public PourprewoolBlock(XiModModElements instance) {
		super(instance, 29);
	}
