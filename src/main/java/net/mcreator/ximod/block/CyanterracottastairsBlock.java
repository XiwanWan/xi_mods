...
public class CyanterracottastairsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:cyanterracottastairs")
	public static final Block block = null;

	public CyanterracottastairsBlock(XiModModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyanterracottastairs");
		}
