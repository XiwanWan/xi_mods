...
public class BordeauxterracottaslabsBlock extends XiModModElements.ModElement {
	@ObjectHolder("xi_mod:bordeauxterracottaslabs")
	public static final Block block = null;

	public BordeauxterracottaslabsBlock(XiModModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bordeauxterracottaslabs");
		}
